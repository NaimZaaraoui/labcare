...
export function ReportHeader({ analysis, settings }: Props) {
  ...
  return (
    <thead className="display-table-header-group">
      <tr>
        <td>
          <div className="flex justify-between items-end mb-8 relative z-10 pt-4 px-4">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-2 bg-black rounded-xl">
                <LucideMicroscope size={40} className="text-white" />
              </div>
              <div className="flex flex-col ml-2">
                <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase print:text-black leading-none">
                  {LAB_NAME}
                </h1>
                <div className="text-[10px] font-black text-slate-600 uppercase tracking-widest mt-2 flex items-center gap-2">
          ...
          <div className="grid grid-cols-12 gap-8 mb-8 relative z-10 px-4">
            <div className="col-span-12 h-px bg-slate-100 print:bg-black/10"></div>
            <div className="col-span-5">
              <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest print:text-black">Patient</span>
              <div className="flex flex-col mt-2">
                <h3 className="text-2xl font-black text-slate-900 mb-2 print:text-black">{patientName}</h3>
            ...
            <div className="col-span-7 grid grid-cols-2 gap-6 pl-8 border-l border-slate-100 print:border-black/10">
              <div>
