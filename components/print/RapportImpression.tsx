...
export const RapportImpression = forwardRef<HTMLDivElement, ReportPrintProps>(
  ({ analysis, results, selectedResultIds = [], settings }, ref) => {
    ...
    return (
      <div ref={ref} className="bg-white font-sans p-10 text-slate-900 w-[210mm] mx-auto relative print:p-0 print:text-black leading-relaxed">
                          ...
                          return (
                            <>
                              <div className="space-y-4">
                                <HistogramView data={parsedHistograms.wbc} title="DISTRIBUTION LEUCOCYTAIRE (WBC)" color="#000000" width={220} height={140} xAxisMax={400} />
                              </div>
                              <div className="space-y-4">
                                <HistogramView data={parsedHistograms.rbc} title="DISTRIBUTION ÉRYTHROCYTAIRE (RBC)" color="#000000" width={220} height={140} xAxisMax={250} />
                              </div>
                              <div className="space-y-4">
