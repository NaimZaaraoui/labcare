...
interface AnalysisPaymentPanelProps {
  paymentTotal: number;
  paymentPaid: number;
          ...
          <div className="mt-2 flex flex-col gap-2 text-xs">
            {hasTierPayant ? (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                <span className="rounded-xl border border-slate-200 bg-white px-3 py-2 font-medium text-[var(--color-text-secondary)] flex flex-col">
            ...
            {paidAt && (
              <span className="rounded-full border border-slate-200 bg-white px-2.5 py-1 font-medium text-[var(--color-text-secondary)] w-fit mt-1">
